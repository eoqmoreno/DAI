...
export default function EntradaData() {
    ...
    return (
        <div className="container">
            ...
            <div className="content">
                <TitleBar text="Entrada de data"></TitleBar>
                ...
                <Input placeholder="Valor mínimo (min)" required={false} name="min" change={setMin}></Input>
                <Input placeholder="Valor máximo (max)" required={false} name="max" change={setMax}></Input>
